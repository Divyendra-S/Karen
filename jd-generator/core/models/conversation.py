...
class Message(BaseModel):
    ...
    message_type: MessageType = Field(
        ...
        description="Type of message for handling logic"
    )
    ...
    related_field: Optional[str] = Field(
        None,
        description="JD field this message relates to"
    )
...
class ConversationMetadata(BaseModel):
    ...
    completion_time_seconds: Optional[int] = Field(
        None,
        ge=0,
        description="Time taken to complete JD generation"
    )
...
class ConversationState(BaseModel):
    ...
    completed_fields: FrozenSet[str] = Field(
        ...
        description="Set of completed JD fields"
    )
    ...
    conversation_history: List[Message] = Field(
        ...
        description="Complete conversation message history"
    )
    ...
    retry_count: int = Field(
        ...
        ge=0,
        le=3,
        description="Number of retries for current field"
    )
    ...
    def user_messages(self) -> List[Message]:
        ...
        return [msg for msg in self.conversation_history if msg.role == MessageRole.USER]
    
    @property
    def assistant_messages(self) -> List[Message]:
        """Get all assistant messages."""
        return [msg for msg in self.conversation_history if msg.role == MessageRole.ASSISTANT]
