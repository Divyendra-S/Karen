...
class Settings(BaseSettings):
    ...
    streamlit_server_address: str = Field("localhost", description="Streamlit server address")
    ...
    # Groq Voice Settings
    whisper_model: str = Field("whisper-large-v3", description="Groq Whisper model for transcription")
